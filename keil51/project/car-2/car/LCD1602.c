...
/**
  ...
  * @retval 无
  */
void number(unsigned char Line,unsigned char Column,unsigned int Number,unsigned char Length)
{
	unsigned char i;
	LCD_SetCursor(Line,Column);
	for(i=Length;i>0;i--)
...
/**
  ...
  * @retval 无
  */
void shi(unsigned char Line,unsigned char Column,int Number,unsigned char Length)
{
	unsigned char i;
...
void bin(unsigned char Line,unsigned char Column,unsigned int Number,unsigned char Length)
{
	...
	for(i=Length;i>0;i--)
	{
		LCD_WriteData(Number/pow(2,i-1)%2+'0');
	}
}
